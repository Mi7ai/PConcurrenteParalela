...
// ============================================================================
  ...
  public static void main( String args[] ) {
    ...
    Thread[] threads = new Hebra3Ciclica[numHebras];
    
    
    for (int i=0; i<numHebras; i++) {
    	threads[i] = new Hebra3Ciclica(i, numHebras, n, vectorX, vectorY);
    	threads[i].start();
    }
    ...
    threads = new Hebra3Bloques[numHebras];
    
    
    for (int i=0; i<numHebras; i++) {
    	threads[i] = new Hebra3Bloques(i, numHebras, n, vectorX, vectorY);
    	threads[i].start();
    }
