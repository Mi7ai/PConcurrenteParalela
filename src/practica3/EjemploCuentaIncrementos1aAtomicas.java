...
// ============================================================================
class MiHebra1aAtomica extends Thread {
// ============================================================================
  int                  tope;
  AtomicInteger  c;

  // --------------------------------------------------------------------------
  public MiHebra1aAtomica( int tope, AtomicInteger c ) {
    this.tope  = tope;
    this.c     = c;
  }
...
// ============================================================================
class EjemploCuentaIncrementos1aAtomicas {
// ============================================================================
  ...
  public static void main( String args[] ) {
    ...
    MiHebra1aAtomica v[] = new MiHebra1aAtomica[ numHebras ];
    AtomicInteger c = new AtomicInteger(0);
    t1 = System.nanoTime();
    System.out.println( "Creando y arrancando " + numHebras + " hebras." );
    for( int i = 0; i < numHebras; i++ ) {
      v[ i ] = new MiHebra1aAtomica( tope, c );
      v[ i ].start();
    }
    for( int i = 0; i < numHebras; i++ ) {
      try {
