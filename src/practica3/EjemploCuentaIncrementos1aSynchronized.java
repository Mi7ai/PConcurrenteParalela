...
// ============================================================================
class MiHebra1aSync extends Thread {
// ============================================================================
  int                  tope;
  CuentaIncrementos1aSync  c;

  // --------------------------------------------------------------------------
  public MiHebra1aSync( int tope, CuentaIncrementos1aSync c ) {
    this.tope  = tope;
    this.c     = c;
  }
...
// ============================================================================
  ...
  public static void main( String args[] ) {
    ...
    MiHebra1aSync v[] = new MiHebra1aSync[ numHebras ];
    CuentaIncrementos1aSync c = new CuentaIncrementos1aSync();
    t1 = System.nanoTime();
    System.out.println( "Creando y arrancando " + numHebras + " hebras." );
    for( int i = 0; i < numHebras; i++ ) {
      v[ i ] = new MiHebra1aSync( tope, c );
      v[ i ].start();
    }
    for( int i = 0; i < numHebras; i++ ) {
      try {
