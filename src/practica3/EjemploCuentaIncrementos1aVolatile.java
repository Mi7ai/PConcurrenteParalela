package practica3;
// ============================================================================
class CuentaIncrementos1aVolatile {
// ============================================================================
...
// ============================================================================
class MiHebra1aVolatile extends Thread {
// ============================================================================
  int                  tope;
  CuentaIncrementos1aVolatile  c;

  // --------------------------------------------------------------------------
  public MiHebra1aVolatile( int tope, CuentaIncrementos1aVolatile c ) {
    this.tope  = tope;
    this.c     = c;
  }
...
// ============================================================================
  ...
  public static void main( String args[] ) {
    ...
    MiHebra1aVolatile v[] = new MiHebra1aVolatile[ numHebras ];
    CuentaIncrementos1aVolatile c = new CuentaIncrementos1aVolatile();
    t1 = System.nanoTime();
    System.out.println( "Creando y arrancando " + numHebras + " hebras." );
    for( int i = 0; i < numHebras; i++ ) {
      v[ i ] = new MiHebra1aVolatile(tope,c);
      v[ i ].start();
    }
    for( int i = 0; i < numHebras; i++ ) {
      try {
