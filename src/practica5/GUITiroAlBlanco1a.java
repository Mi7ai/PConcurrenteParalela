...
public class GUITiroAlBlanco1a {
  ...
  JButton            btnDispara;
  LinkedBlockingQueue<NuevoDisparo> lbq;
  MiHebraCalculadora2 hebra;
  ...
  public void go() {
    SwingUtilities.invokeLater(new Runnable(){
      public void run(){
    	...
    	hebra = new MiHebraCalculadora2(lbq, cnvCampoTiro, txfMensajes);
          ...
          public void actionPerformed( ActionEvent e ) {
            ...
            try {
              ...
              if( ( 0.0 < angulo )&&( angulo < 90 )&&( velocidad > 0 ) ) {
                ...
                NuevoDisparo nuevoDisparo = new NuevoDisparo(velocidad, angulo);
                try{
                	lbq.put(nuevoDisparo);
