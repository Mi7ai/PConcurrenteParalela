...
class Ejercicio {
  public static void main(String[] args) {
    ...
    //
    //Implementacion gestion propia
    //
    
    System.out.println();
    t1 = System.nanoTime();
    MaxMin = new PuebloMaximaMinima();
    LinkedBlockingQueue<Tarea> lbq = new LinkedBlockingQueue<>();
        
    obtenMayorDiferencia_ParalelaDeFichero(fecha, codProvincia, MaxMin, lbq, numHebras);  

    t2 = System.nanoTime();
    tp = ( ( double ) ( t2 - t1 ) ) / 1.0e9; 
    System.out.print( "Implementacion con gestion propia.                           " );
    System.out.println( " Tiempo(s): " + tp );
    System.out.println( "  Pueblo: " + MaxMin.damePueblo() + " , Maxima = " +
                           MaxMin.dameTemperaturaMaxima() + " , Minima = " +
                           MaxMin.dameTemperaturaMinima() );
    System.out.println("Incremento: "+ ts/tp);
    
    
    //
    //Implementacion Thread Pool
    //
    System.out.println();
    t1 = System.nanoTime();
    MaxMin = new PuebloMaximaMinima();
    ...
    obtenMayorDiferencia_ThreadPoolDeFichero(fecha, codProvincia, MaxMin, exec);
    ...
    t2 = System.nanoTime();
    tp = ( ( double ) ( t2 - t1 ) ) / 1.0e9; 
    System.out.print( "Implementacion con Thread Pool.                           " );
    System.out.println( " Tiempo(s): " + tp );
    System.out.println( "  Pueblo: " + MaxMin.damePueblo() + " , Maxima = " +
                           MaxMin.dameTemperaturaMaxima() + " , Minima = " +
                           MaxMin.dameTemperaturaMinima() );
    ...
    //
    //Implementacion Thread Pool Await
    //
    System.out.println();
    t1 = System.nanoTime();
    MaxMin = new PuebloMaximaMinima();
    ...
    obtenMayorDiferencia_ThreadPoolAwaitDeFichero(fecha, codProvincia, MaxMin, exec);
    
    t2 = System.nanoTime();
    tp = ( ( double ) ( t2 - t1 ) ) / 1.0e9; 
    System.out.print( "Implementacion con Thread Pool Await.                           " );
    System.out.println( " Tiempo(s): " + tp );
    System.out.println( "  Pueblo: " + MaxMin.damePueblo() + " , Maxima = " +
                           MaxMin.dameTemperaturaMaxima() + " , Minima = " +
                           MaxMin.dameTemperaturaMinima() );
  ...
  public static void obtenMayorDiferencia_ParalelaDeFichero (String fecha, int codProvincia,
	...
	// Procesa el fichero "codPueblos.txt"
		...
		// hacer una lectura comoda (disponer del metodo readLine()).
			...
			fr = new FileReader (archivo);
			br = new BufferedReader(fr);
			Consumidora[] vH = new Consumidora[numHebras];
			for (int i=0; i<numHebras; i++){
				vH [i]= new Consumidora(lbq, fecha, MaxMin);
				vH[i].start();
			}
  ...
  public static void obtenMayorDiferencia_ThreadPoolAwaitDeFichero (String fecha, int codProvincia,
          PuebloMaximaMinima MaxMin, ExecutorService exec) {
	File           archivo = null;
	FileReader     fr      = null;
	BufferedReader br      = null;
